    ...
    >
      ...
      >
        ...
        <div style={{ flex: "1 1 250px", margin: "10px" }}>
          ...
          <p>
            Plan your perfect journey effortlessly and explore the world with
        ...
        <div style={{ flex: "1 1 150px", margin: "10px" }}>
          ...
          <ul style={{ listStyle: "none", padding: 0, lineHeight: "1.8" }}>
            ...
            <li>
              <Link to="/enquiry" style={linkStyle}>
                Enquiry
              </Link>
            </li>
          </ul>
        ...
        <div style={{ flex: "1 1 250px", margin: "10px" }}>
          ...
          <p>
            <MapPin size={16} style={iconStyle} /> SH-19, SMS, Varanasi, India
          </p>
          <p>
            <Phone size={16} style={iconStyle} /> +91 9336194294
          </p>
          <p>
            <Mail size={16} style={iconStyle} /> tourplanner@gmail.com
          </p>
        </div>
